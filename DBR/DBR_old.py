...
profit
'''
#gonna need to make a dbr laser class i think finally

LOG_VOLTAGE = helper.get_user_input("Read Voltage Y/N: ", input_type="y/n")
if LOG_VOLTAGE:
...
def laser_manual_scan(self, inst):
...
def laser_auto_scan(
    ...
    if SENDING_PACKETS:
        ...
        if LOG_VOLTAGE:
            ...
            def get_voltage():
                print(inst.query("*IDN?"))
                print(f"V = {inst.query("MEAS:VOLT:DC? 0.100,0.001")}")
